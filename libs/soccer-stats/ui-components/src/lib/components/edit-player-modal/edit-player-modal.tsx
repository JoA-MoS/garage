...
import { SOCCER_POSITIONS } from '../../constants/positions';
...
export interface EditPlayerFormUpdates {
  firstName?: string;
  lastName?: string;
  email?: string;
  phone?: string;
