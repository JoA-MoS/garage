...
export interface CascadeDeleteModalProps {
  ...
  isOpen: boolean;
  /** Type of the event being deleted (e.g., 'goal', 'substitution') */
  eventType: string;
  /** List of dependent events that will also be deleted */
...
/**
 * Modal for confirming cascade deletion of events with their dependencies.
 * Shows a list of dependent events that will also be deleted.
 */
