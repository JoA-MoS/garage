...
export const UserCardSmartComponent = ({
  ...
  return (
    <UserCardPresentation
      ...
      primaryTeam={user.teamPlayers?.[0]?.team.name}
      primaryPosition={user.teamPlayers?.[0]?.primaryPosition || undefined}
      primaryJersey={user.teamPlayers?.[0]?.jerseyNumber || undefined}
