...
const documents: Documents = {
  ...
  '\n  query GetMyRoleInTeam($teamId: ID!) {\n    myRoleInTeam(teamId: $teamId) {\n      id\n      role\n      isGuest\n    }\n  }\n':
    types.GetMyRoleInTeamDocument,
  '\n  mutation TransferTeamOwnership($teamId: ID!, $newOwnerId: ID!) {\n    transferTeamOwnership(teamId: $teamId, newOwnerId: $newOwnerId) {\n      id\n      role\n      user {\n        id\n        firstName\n        lastName\n        email\n      }\n    }\n  }\n':
    types.TransferTeamOwnershipDocument,
  '\n  mutation AddTeamMember(\n    $teamId: ID!\n    $userId: ID!\n    $role: TeamRole!\n    $linkedPlayerId: ID\n    $isGuest: Boolean\n  ) {\n    addTeamMember(\n      teamId: $teamId\n      userId: $userId\n      role: $role\n      linkedPlayerId: $linkedPlayerId\n      isGuest: $isGuest\n    ) {\n      id\n      role\n      isGuest\n      user {\n        id\n        firstName\n        lastName\n        email\n      }\n    }\n  }\n':
  ...
  '\n  mutation PromoteGuestCoach($membershipId: ID!) {\n    promoteGuestCoach(membershipId: $membershipId) {\n      id\n      role\n      isGuest\n      user {\n        id\n        firstName\n        lastName\n      }\n    }\n  }\n':
    types.PromoteGuestCoachDocument,
  '\n  query GetAllUsersForMemberSelection {\n    users {\n      id\n      firstName\n      lastName\n      email\n    }\n  }\n':
    types.GetAllUsersForMemberSelectionDocument,
  '\n  query GetTeamPlayersForLinking($teamId: ID!) {\n    playersByTeam(teamId: $teamId) {\n      id\n      firstName\n      lastName\n    }\n  }\n':
    types.GetTeamPlayersForLinkingDocument,
  '\n  query GetTeams {\n    teams {\n      id\n      name\n      shortName\n      description\n      homePrimaryColor\n      homeSecondaryColor\n      awayPrimaryColor\n      awaySecondaryColor\n      logoUrl\n      isActive\n      isManaged\n      sourceType\n      createdAt\n      updatedAt\n    }\n  }\n':
