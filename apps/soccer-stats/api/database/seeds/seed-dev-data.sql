...
VALUES (
    ...
    (
      SELECT "clerkId"
      FROM users
      WHERE email = 'joamos.dev@gmail.com'
    ),
    NOW(),
    NOW()
  ) ON CONFLICT (id) DO
...
SELECT 'd4e5f6a7-b8c9-0123-defa-234567890123',
  ...
  NOW()
FROM users
WHERE email = 'joamos.dev@gmail.com' ON CONFLICT (id) DO NOTHING;
...
VALUES (
  ...
  (
    '11000001-0000-0000-0000-000000000007',
    'player7@example.com',
    'Taylor',
    'Moore',
    NOW(),
  ...
  (
    '11000001-0000-0000-0000-000000000008',
    'player8@example.com',
    'Jamie',
    'Taylor',
    NOW(),
...
VALUES (
  ...
  (
    '22000001-0000-0000-0000-000000000006',
    'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
    '11000001-0000-0000-0000-000000000006',
    NOW(),
    true,
  ...
  (
    '22000001-0000-0000-0000-000000000007',
    'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
    '11000001-0000-0000-0000-000000000007',
    NOW(),
    true,
  ...
  (
    '22000001-0000-0000-0000-000000000008',
    'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
    '11000001-0000-0000-0000-000000000008',
    NOW(),
    true,
...
VALUES (
    '23000001-0000-0000-0000-000000000001',
    '22000001-0000-0000-0000-000000000001',
    'PLAYER',
    '{"jerseyNumber": "1", "primaryPosition": "GK"}',
    NOW(),
    NOW()
  ),
  (
    '23000001-0000-0000-0000-000000000002',
    '22000001-0000-0000-0000-000000000002',
    'PLAYER',
    '{"jerseyNumber": "7", "primaryPosition": "LW"}',
    NOW(),
    NOW()
  ),
  (
    '23000001-0000-0000-0000-000000000003',
    '22000001-0000-0000-0000-000000000003',
    'PLAYER',
    '{"jerseyNumber": "10", "primaryPosition": "CM"}',
    NOW(),
    NOW()
  ),
  (
    '23000001-0000-0000-0000-000000000004',
    '22000001-0000-0000-0000-000000000004',
    'PLAYER',
    '{"jerseyNumber": "4", "primaryPosition": "CB"}',
    NOW(),
    NOW()
  ),
  (
    '23000001-0000-0000-0000-000000000005',
    '22000001-0000-0000-0000-000000000005',
    'PLAYER',
    '{"jerseyNumber": "9", "primaryPosition": "ST"}',
    NOW(),
    NOW()
  ),
  (
    '23000001-0000-0000-0000-000000000006',
    '22000001-0000-0000-0000-000000000006',
    'PLAYER',
    '{"jerseyNumber": "11", "primaryPosition": "RW"}',
    NOW(),
    NOW()
  ),
  (
    '23000001-0000-0000-0000-000000000007',
    '22000001-0000-0000-0000-000000000007',
    'PLAYER',
    '{"jerseyNumber": "5", "primaryPosition": "CDM"}',
    NOW(),
    NOW()
  ),
  (
    '23000001-0000-0000-0000-000000000008',
    '22000001-0000-0000-0000-000000000008',
    'PLAYER',
    '{"jerseyNumber": "3", "primaryPosition": "LB"}',
    NOW(),
    NOW()
...
VALUES (
  ...
  (
    '55000001-0000-0000-0000-000000000003',
    '33000001-0000-0000-0000-000000000001',
    '44000001-0000-0000-0000-000000000001',
    (
      SELECT id
  ...
  (
    '55000001-0000-0000-0000-000000000004',
    '33000001-0000-0000-0000-000000000001',
    '44000001-0000-0000-0000-000000000001',
    (
      SELECT id
  ...
  (
    '55000001-0000-0000-0000-000000000005',
    '33000001-0000-0000-0000-000000000001',
    '44000001-0000-0000-0000-000000000001',
    (
      SELECT id
  ...
  (
    '55000001-0000-0000-0000-000000000006',
    '33000001-0000-0000-0000-000000000001',
    '44000001-0000-0000-0000-000000000001',
    (
      SELECT id
...
VALUES (
    '55000001-0000-0000-0000-000000000010',
    '33000001-0000-0000-0000-000000000001',
    '44000001-0000-0000-0000-000000000001',
    (
      SELECT id
  ...
  (
    '55000001-0000-0000-0000-000000000011',
    '33000001-0000-0000-0000-000000000001',
    '44000001-0000-0000-0000-000000000001',
    (
      SELECT id
    ...
    1695,
    '2',
    NOW() - INTERVAL '7 days' + INTERVAL '33 minutes',
    NOW()
  ),
  (
    '55000001-0000-0000-0000-000000000012',
    '33000001-0000-0000-0000-000000000001',
    '44000001-0000-0000-0000-000000000001',
    (
      SELECT id
    ...
    1020,
    '2',
    NOW() - INTERVAL '7 days' + INTERVAL '47 minutes',
    NOW()
  ) ON CONFLICT (id) DO NOTHING;
-- Game 1 assists
INSERT INTO game_events (
...
VALUES (
    '55000001-0000-0000-0000-000000000020',
    '33000001-0000-0000-0000-000000000001',
    '44000001-0000-0000-0000-000000000001',
    (
      SELECT id
  ...
  (
    '55000001-0000-0000-0000-000000000021',
    '33000001-0000-0000-0000-000000000001',
    '44000001-0000-0000-0000-000000000001',
    (
      SELECT id
...
VALUES (
    '55000002-0000-0000-0000-000000000001',
    '33000001-0000-0000-0000-000000000002',
    '44000001-0000-0000-0000-000000000003',
    (
      SELECT id
  ...
  (
    '55000002-0000-0000-0000-000000000002',
    '33000001-0000-0000-0000-000000000002',
    '44000001-0000-0000-0000-000000000003',
    (
      SELECT id
  ...
  (
    '55000002-0000-0000-0000-000000000003',
    '33000001-0000-0000-0000-000000000002',
    '44000001-0000-0000-0000-000000000003',
    (
      SELECT id
...
VALUES (
    '55000002-0000-0000-0000-000000000010',
    '33000001-0000-0000-0000-000000000002',
    '44000001-0000-0000-0000-000000000003',
    (
      SELECT id
...
VALUES (
    '44000001-0000-0000-0000-000000000005',
    '33000001-0000-0000-0000-000000000003',
    'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
    'home',
    NOW(),
  ...
  (
    '44000001-0000-0000-0000-000000000006',
    '33000001-0000-0000-0000-000000000003',
    'b2c3d4e5-f6a7-8901-bcde-f12345678901',
    'away',
    NOW(),
...
VALUES (
    '44000001-0000-0000-0000-000000000007',
    '33000001-0000-0000-0000-000000000004',
    'c3d4e5f6-a7b8-9012-cdef-123456789012',
    'home',
    NOW(),
  ...
  (
    '44000001-0000-0000-0000-000000000008',
    '33000001-0000-0000-0000-000000000004',
    'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
    'away',
    NOW(),
...
VALUES (
    '55000004-0000-0000-0000-000000000001',
    '33000001-0000-0000-0000-000000000004',
    '44000001-0000-0000-0000-000000000008',
    (
      SELECT id
  ...
  (
    '55000004-0000-0000-0000-000000000002',
    '33000001-0000-0000-0000-000000000004',
    '44000001-0000-0000-0000-000000000008',
    (
      SELECT id
  ...
  (
    '55000004-0000-0000-0000-000000000003',
    '33000001-0000-0000-0000-000000000004',
    '44000001-0000-0000-0000-000000000008',
    (
      SELECT id
  ...
  (
    '55000004-0000-0000-0000-000000000004',
    '33000001-0000-0000-0000-000000000004',
    '44000001-0000-0000-0000-000000000008',
    (
      SELECT id
  ...
  (
    '55000004-0000-0000-0000-000000000005',
    '33000001-0000-0000-0000-000000000004',
    '44000001-0000-0000-0000-000000000008',
    (
      SELECT id
    ...
    '{"period": "2"}',
    NOW() - INTERVAL '14 days' + INTERVAL '55 minutes',
    NOW()
  ),
  (
    '55000004-0000-0000-0000-000000000006',
    '33000001-0000-0000-0000-000000000004',
    '44000001-0000-0000-0000-000000000008',
    (
      SELECT id
...
VALUES (
    '55000004-0000-0000-0000-000000000010',
    '33000001-0000-0000-0000-000000000004',
    '44000001-0000-0000-0000-000000000008',
    (
      SELECT id
...
-- ============================================
-- GAME 5: Completed 4v4 (Thunder FC 2-1 Lightning United, 2 days ago)
-- ============================================
INSERT INTO games (
    id,
    "gameFormatId",
...
VALUES (
    '44000001-0000-0000-0000-000000000009',
    '33000001-0000-0000-0000-000000000005',
    'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
    'home',
    NOW(),
  ...
  (
    '44000001-0000-0000-0000-000000000010',
    '33000001-0000-0000-0000-000000000005',
    'b2c3d4e5-f6a7-8901-bcde-f12345678901',
    'away',
    NOW(),
...
-- 4v4 quarter-based timing and goals
INSERT INTO game_events (
    id,
    "gameId",
    "gameTeamId",
...
VALUES (
    '55000005-0000-0000-0000-000000000001',
    '33000001-0000-0000-0000-000000000005',
    '44000001-0000-0000-0000-000000000009',
    (
      SELECT id
  ...
  (
    '55000005-0000-0000-0000-000000000002',
    '33000001-0000-0000-0000-000000000005',
    '44000001-0000-0000-0000-000000000009',
    (
      SELECT id
  ...
  (
    '55000005-0000-0000-0000-000000000003',
    '33000001-0000-0000-0000-000000000005',
    '44000001-0000-0000-0000-000000000009',
    (
      SELECT id
  ...
  (
    '55000005-0000-0000-0000-000000000004',
    '33000001-0000-0000-0000-000000000005',
    '44000001-0000-0000-0000-000000000009',
    (
      SELECT id
...
VALUES (
    '55000005-0000-0000-0000-000000000010',
    '33000001-0000-0000-0000-000000000005',
    '44000001-0000-0000-0000-000000000009',
    (
      SELECT id
  ...
  (
    '55000005-0000-0000-0000-000000000011',
    '33000001-0000-0000-0000-000000000005',
    '44000001-0000-0000-0000-000000000010',
    (
      SELECT id
  ...
  (
    '55000005-0000-0000-0000-000000000012',
    '33000001-0000-0000-0000-000000000005',
    '44000001-0000-0000-0000-000000000009',
    (
      SELECT id
    ...
    420,
    '4',
    NOW() - INTERVAL '2 days' + INTERVAL '37 minutes',
    NOW()
  ) ON CONFLICT (id) DO NOTHING;
-- ============================================
-- GAME 6: Scheduled 7v7 (Thunder FC vs Storm City, tomorrow)
-- ============================================
INSERT INTO games (
    id,
    "gameFormatId",
...
VALUES (
    '44000001-0000-0000-0000-000000000011',
    '33000001-0000-0000-0000-000000000006',
    'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
    'home',
    NOW(),
  ...
  (
    '44000001-0000-0000-0000-000000000012',
    '33000001-0000-0000-0000-000000000006',
    'c3d4e5f6-a7b8-9012-cdef-123456789012',
    'away',
    NOW(),
...
-- ============================================
-- GAME 7: Scheduled 9v9 (Thunder FC vs Lightning United, 5 days from now)
-- ============================================
INSERT INTO games (
    id,
    "gameFormatId",
...
VALUES (
    '33000001-0000-0000-0000-000000000007',
    (
      SELECT id
      FROM game_formats
      WHERE name = '9v9'
...
VALUES (
    '44000001-0000-0000-0000-000000000013',
    '33000001-0000-0000-0000-000000000007',
    'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
    'home',
    NOW(),
  ...
  (
    '44000001-0000-0000-0000-000000000014',
    '33000001-0000-0000-0000-000000000007',
    'b2c3d4e5-f6a7-8901-bcde-f12345678901',
    'away',
    NOW(),
...
FROM team_members
WHERE "teamId" = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890';
SELECT 'Team Member Roles: ' || COUNT(*)
...
SELECT 'Events: ' || COUNT(*)
FROM game_events
WHERE "gameId"::text LIKE '33000001%';