...
interface SubstitutionsTabPresentationProps {
...
export const SubstitutionsTabPresentation = ({
  substitutionRecommendations,
  playersOnField,
  playersOnBench,
  onSubstitute,
}: SubstitutionsTabPresentationProps) => {
  return (
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-gray-500">
              Click on players to select for substitution
            </p>
          </div>
        </div>
      </div>
